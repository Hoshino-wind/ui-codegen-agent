...
- Verify that exported integration contracts still match the LayerDoc source, generated project selectors, preview selectors, layer bounds, layer style, layer copy, asset URIs, responsive CSS, and interaction metadata.
